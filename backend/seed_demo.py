...
def seed():
    ...
    with get_conn() as conn:
        ...
        for table in ("dictations", "vitals", "timestamps", "scribbles", "photos", "signatures", "calls"):
    ...
    print(f"Seeded demo call '{call_id}'. Start the server and visit http://localhost:8000/ (phone app)")
